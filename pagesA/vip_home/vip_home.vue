<template>
	...
	<view class="minh100" >
		<image class="head_box_img" src="/static/images/vip_lvbg_01.jpg" mode="aspectFill"></image>
		...
		<cu-custom bgImage="/static/images/vip_lvbg_01.jpg" :isBack="true">
		...
		<block v-if="htmlReset==0">
			 ...
			 @change="cardSwiper" indicator-color="#8799a3" indicator-active-color="#0081ff">
				<swiper-item v-for="(item,index) in swiperList" :key="item.id" :class="cardCur==index?'cur':''">
					<view class="swiper-item">
						...
						<block v-if="cardCur==myvip&&cardCur==index">
			...
			<view class="vip_box">
				<image class="vip_box_qy" :src="swiperList[cardCur].qy" mode="aspectFill"></image>
