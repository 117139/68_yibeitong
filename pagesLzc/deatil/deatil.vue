<template>
	<view class="content" v-if="isReady">
			...
			<view class="detail_fan dis_flex" style="flex-wrap: wrap;">
				<view class="detail_fan1">
					<text class="detail_fan1_1">返</text> <text
						class="detail_fan1_2">购物返现:￥{{shuju.o_up_superior_rebate_sum}}</text>
				</view>
				<view class="detail_fan1">
					<text class="detail_fan1_1">返</text> <text
						class="detail_fan1_2">一级返现:￥{{shuju.o_superior_rebate_sum}}</text>
				</view>
				<view class="detail_fan1">
					<text class="detail_fan1_1">返</text> <text
						class="detail_fan1_2">二级返现:￥{{shuju.o_consumer_rebate_sum}}</text>
				</view>
			</view>
		...
		<view class="footDetail dis_flex ju_b">
			...
			<view class="gouDetail dis_flex aic ju_c" @click="gouBtn">立即购买</view>
		</view>
	</view>
</template>
